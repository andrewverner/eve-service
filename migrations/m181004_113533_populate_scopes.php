...
/**
 * Class m181004_113533_populate_scopes
 */
class m181004_113533_populate_scopes extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->dropColumn(\app\models\Scope::tableName(), 'mask');
        ...
        foreach ($scopes as $scope => $title) {
            $this->insert(\app\models\Scope::tableName(), [
                'scope' => $scope,
                'description' => $title,
                'active' => 1,
            ]);
    ...
    {
        $this->truncateTable(\app\models\Scope::tableName());
    }
    ...
    {
        echo "m181004_113533_populate_scopes cannot be reverted.\n";
